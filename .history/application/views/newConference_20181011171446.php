<?php ?>
  ...
  <input type="text" value='Contenu' disabled><input type="text" value="<?php echo ($numeroConf[0]->idConf)+1 ?>">
  <input type="text" value="Choix du niveau" disabled><input type="text" value=""><br>
